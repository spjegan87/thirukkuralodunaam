<?php
	...
	$sql ="UPDATE gallery_register SET gallerytitle='$gallerytitle',gallerytext='$gallerytext',photo='$photo',photo1='$photo1',photo2='$photo2',photo3='$photo3',photo4='$photo4',status='$gallerystatus' WHERE id='$id'";
