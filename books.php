		...
		<div class="service-container">
			<div class="row">
				...
				<?php
					...
					$sql = "SELECT * FROM book_register  where status='Active' ORDER BY id ASC LIMIT $start_from, $limit";
					$rs_result = mysql_query($sql);  
				?>
				<?php  
					while ($row = mysql_fetch_assoc($rs_result)) {
				?> 
				<div class="col-md-3 pagecount">
					<div class="b-container">
						<img src="admin/books/<?php echo $row['photo'] ?>" border="0" alt="" class="img-reponsive" />
						<h3><?php echo $row['bookname'] ?></h3><p><?php echo $row['bookcontent'] ?></p>
						<a href="booksdetails.php?id=<?php echo $row['id'] ?>" class="btn custom-btn">Read more</a>
					</div>
				</div>
				<?php
					};
